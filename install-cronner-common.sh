...
wget https://github.com/theckman/cronner/releases/download/v1.0.0/cronner-linux-amd64-v1.0.0.tar.gz
...
wget https://raw.githubusercontent.com/managedbyq/cronner-utils/master/cronner-wrap
